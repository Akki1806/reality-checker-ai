  ...
  return (
    <div className="flex flex-col items-center gap-4 py-6" data-testid="display-reality-score">
      <div className="flex flex-col items-center gap-1">
        ...
        <div className="text-[0.65rem] font-mono uppercase tracking-[0.25em] text-muted-foreground/60">
          / 100 — Reality Score
        </div>
      </div>

      {scoreReason && (
        <p className="text-xs text-muted-foreground/70 text-center max-w-[220px] leading-relaxed font-mono italic">
          "{scoreReason}"
        </p>
      )}
            ...
            <CardHeader className="pb-2 pt-5">
              <div className="flex items-center justify-between gap-3 flex-wrap">
                <div className="flex items-center gap-2">
                  ...
                  <Badge
                    variant="outline"
                    className="font-mono px-2 py-0.5 text-[0.6rem] border border-white/10 bg-white/5 text-muted-foreground/70 capitalize gap-1 flex items-center"
                    data-testid="badge-category"
                  >
                    {getCategoryIcon(mutation.data.category)}
